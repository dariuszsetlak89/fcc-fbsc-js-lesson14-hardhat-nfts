    ...
    : describe("Dynamic SVG NFT Unit Tests", function () {
          ...
          describe("mintNft", () => {
              ...
              it("Shifts the token uri to lower when the price doesn't surpass the highvalue", async () => {
                  const highValue = ethers.utils.parseEther("100000000"); // $100,000,000 per ETH
          ...
          describe("tokenURI", () => {
              it("Reverts transaction, when token doesn't exist", async () => {
                  // const nft = await dynamicSvgNft.mintNft(33); // create NFT - uncomment to fail test
          ...
          // This will increase test coverage.
      });
